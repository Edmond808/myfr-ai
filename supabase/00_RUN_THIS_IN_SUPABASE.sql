-- ============================================================
-- myfr.ai — full database setup. Run this whole file ONCE in
-- the Supabase SQL editor (Dashboard → SQL Editor → New query →
-- paste → Run). It is schema.sql + the accept_quote migration,
-- in the correct order. Safe to run on a fresh project.
-- ============================================================
-- After it succeeds, do TWO clicks in the Dashboard:
--   1. Database → Replication (or Realtime) → enable for table "quotes"
--   2. Authentication → Providers → enable Email (+ Google/Apple if wanted)
-- ============================================================

-- >>> PASTE POINT: this file already contains both parts below <<<
